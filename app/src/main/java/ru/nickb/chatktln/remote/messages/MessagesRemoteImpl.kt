...
class MessagesRemoteImpl  @Inject constructor(
    ...
    override fun getMessagesWithContact(
        ...
        return request.make(service.getMessagesWithContact(createGetMessageWithContactMap(contactId, userId, token))) {it.messages}
    }
    ...
    private fun createGetMessageWithContactMap(
        contactId: Long,
        userId: Long,
        token: String
    ): Map<String, String> {
