...
class FriendsRemoteImpl @Inject constructor(private val request: Request, private val service: ApiService): FriendsRemote {
    ...
    override fun approveFriendRequst(
        userId: Long,
        requestUserId: Long,
        friendsId: Long,
        token: String
    ...
    override fun addFriend(userId: Long, email: String, token: String): Either<Failure, None> {
