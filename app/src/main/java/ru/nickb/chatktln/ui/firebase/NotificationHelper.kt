...
import ru.nickb.chatktln.domain.messages.ContactEntity
...
class NotificationHelper @Inject constructor(val context: Context, val getMessagesWithContact: GetMessagesWithContact) : ContextWrapper(context) {
