package ru.nickb.chatktln.domain.interactor
...
/**
    ...
    *Type тип возвращаемого объекта с данными. Params тип класса оболочки хранящей параметры для выполнения функции.
 *
 */
